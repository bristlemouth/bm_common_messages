...
/////////////////////////////
typedef enum {
  BM_COMMON_CFG_PARTITION_USER = (1 << 0),
  BM_COMMON_CFG_PARTITION_SYSTEM = (1 << 1),
  BM_COMMON_CFG_PARTITION_HARDWARE = (1 << 2),
  BM_COMMON_CFG_PARTITION_ALL = (BM_COMMON_CFG_PARTITION_USER | BM_COMMON_CFG_PARTITION_SYSTEM | BM_COMMON_CFG_PARTITION_HARDWARE),
