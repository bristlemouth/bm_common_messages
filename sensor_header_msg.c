...
CborError sensor_header_encode(CborEncoder * const map_encoder,
    ...
    /* this is SensorHeaderMsg::encode but de-namespaced, de-structed, and de-call-by-referenced */
...
CborError sensor_header_decode(uint32_t * const version_p,
                               ...
                               CborValue * const map) {
    /* this is SensorHeaderMsg::decode but de-namespaced, de-structed, and de-call-by-referenced */
    CborError err = CborNoError;
